#!/usr/bin/env python3
"""
TikTok Cover/Thumbnail Downloader
Downloads the cover (thumbnail) image of a TikTok video.
...
def extract_video_id(url: str) -> str:
    """Extract video ID from a TikTok URL or return as-is if already an ID."""
    patterns = [
...
def download_cover(
    ...
    """
    Download the cover/thumbnail image of a TikTok video.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Download TikTok video cover/thumbnail image")
